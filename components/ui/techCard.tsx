  ...
  return (
    ...
    >
      <a href={link} className="md:w-fit w-full">
        <div className="flex bg-slate-50 rounded-md justify-between items-center p-3 gap-4  w-full md:w-52">
          <div className="bg-muted h-16 w-16 rounded-md p-2 grid place-content-center">
